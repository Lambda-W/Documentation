...
| Icon             | Texture to represent the landmark on the minimap, compass and waypoint widgets. Only available when bUseSlateIcon is set to false.                                                                                                                                                                                                                                                              |
| bUseSlateIcon    | If true, use the SlateIcon struct instead of the Icon Texture2d to represent this landmark on screen.                                                                                                                                                                                                                                                                                           |
| SlateIcon        | Texture or UI material to represent the landmark on the minimap, compass and waypoint widgets. This offers more customisation than the Icon UTexture2D. Only available when bUseSlateIcon is set to false. Please note that if you use a UI Material, the 'Draw Debug Landmark' feature won't be able to display the material (see [`ULandmarkComponent`](LandmarkComponent){:target="blank"}). |
